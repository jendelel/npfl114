...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", default=23, type=int, help="Number of epochs.")
    ...
    with open("labels_best.txt", "w") as f:
        for prediction in test_predictions:
            print(data_test.vocabulary('languages')[prediction], file=f)
