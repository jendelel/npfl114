...
class Network:
    def __init__(self, logdir, experiment, threads):
        ...
        hidden_layer2 = layers.fully_connected(hidden_layer, num_outputs=HIDDEN, activation_fn=tf.tanh, scope="hidden_layer2")
        output_layer = layers.fully_connected(hidden_layer2, num_outputs=LABELS, activation_fn=None, scope="output_layer")
